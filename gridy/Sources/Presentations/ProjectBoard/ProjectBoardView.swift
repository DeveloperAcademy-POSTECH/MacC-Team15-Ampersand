...
//
//    @State var hoveredItem = ""
//    @State var clickedItem = ""
//    @State private var isExpanded = true
//    
//    var body: some View {
//        let isNotificationButtonClicked = Binding(
//            get: { self.clickedItem == .notificationButton },
//            set: { newValue in self.clickedItem = newValue ? .notificationButton : "" }
//        )
//        let isUerSettingButtonClicked = Binding(
//            get: { self.clickedItem == .shareImageButton },
//            set: { newValue in self.clickedItem = newValue ? .shareImageButton : "" }
//        )
//        let isCreatePlanBoardButtonClicked = Binding(
//            get: { self.clickedItem == .boardSettingButton },
//            set: { newValue in self.clickedItem = newValue ? .boardSettingButton : "" }
//        )
...
//            NotificationView()
//        }
//        .sheet(isPresented: isUerSettingButtonClicked) {
//            UserSettingView()
//        }
//        .sheet(isPresented: isCreatePlanBoardButtonClicked) {
//            CreatePlanBoardView()
//        }
//    }
//}
